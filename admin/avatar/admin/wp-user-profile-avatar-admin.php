...
class WPUPA_Admin {
	...
	{
		wp_register_style( 'wp-user-profile-avatar-backend', get_template_directory_uri().'/admin/avatar/assets/css/backend.min.css' );

		wp_register_script( 'wp-user-profile-avatar-admin-avatar', get_template_directory_uri().'/admin/avatar/assets/js/admin-avatar.min.js', array( 'jquery' ), WPUPA_VERSION, true);
		...
		wp_localize_script( 'wp-user-profile-avatar-admin-avatar', 'wp_user_profile_avatar_admin_avatar', array( 
								...
								'default_avatar' => get_template_directory_uri().'/admin/avatar/assets/images/wp-user-thumbnail.png',
							)
						);
    ...
    {
        $plugins['wp_user_profile_avatar_shortcodes'] = get_template_directory_uri().'/admin/avatar/assets/js/admin-avatar.js';
        return $plugins;
    }
